...
#define WIRE_VALUE_CONST16(w) (((w) & 0xff) << 8 | (((w) >> 8) & 0xff))

#define WIRE_VALUE32(l) ((((PUCHAR) &l)[3]<<24) | (((PUCHAR) &l)[2]<<16) | \
                         (((PUCHAR) &l)[1]<<8)  |  ((PUCHAR) &l)[0]       )

#define WIRE_VALUE_CONST32(l) (((l) & 0xff) << 24 | ((l) & 0xff00) << 8 | \
                               ((l) & 0xff0000) >> 8 | \
                               ((l) & 0xff000000) >> 24)
...
#define WIRE_VALUE_CONST16(w) w
#define WIRE_VALUE_CONST32(l) l
