...
*  $Id$
*
*  Copyright 1994-2017 Citrix Systems, Inc. All Rights Reserved.
*
********************************************************************/

#ifndef __LOGFLAGS_H__
#define __LOGFLAGS_H__
#if !defined(DEBUG) || defined(NEW_LOGGING) //if we have old logging on we can't have the newer logging mechansim

#include "ctxlog.h"
#define LOGINIT(arg) CtxLogInit()
#define LOGCLOSE() CtxLogShutdown()

#else
// LogInit is for ncs.log.<pid>
// CtxLogInit is from ctxlogd and is for /var/log/Citrix/ICAClient.log
// Some components such as IcaGraphics expects __CtxTrace which is part of CtxLogInit/ctxlogd
#define LOGINIT(arg) {LogInit(arg);CtxLogInit();}
#define LOGCLOSE() {LogClose();CtxLogShutdown();}
/* 
 *  LOG CLASS defines
 */
...
#define TC_MTOP     TC_VD          /* 0x00000080 */
...
/*
 * Support for keyboard layout dynamic Sync.
 */
#define TC_IME     TC_KEY
...
#define TT_AOL          0x00200000          /* Always On logging flag */
...
/* Trace flag for sensitive information*/

#define TT_DEBUG	    0x10000000			/* Marking sensitive messages that should not go into the Retail Logs */
