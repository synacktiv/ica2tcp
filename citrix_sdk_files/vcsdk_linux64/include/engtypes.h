...
*   $Id$
*
*  Copyright 1995-2014 Citrix Systems, Inc.  All Rights Reserved
*
****************************************************************************/
...
typedef struct _WFELOAD {
   ...
   ULONG        DllFlags;       /* DLL flags (embedded, global ...) */
   const char  *DllLoad;
...
// Hardware Id
//
typedef struct _HARDWARE_ID
{
    PBYTE   pHardwareId;            // client computer Hardware Id
    LONG    HardwareIdLength;       // client computer Hardware Id length
    USHORT  HardwareIdVersion;      // server Hardware Id capability version
