...
/* Define a signed generic named rectangle for common use.
   Note: this is the same as TWI_RECT except defined in a common place
   with a generic name for common use. */
...
long Getmsec(void);      /* Get time in 1/1000 seconds. */
